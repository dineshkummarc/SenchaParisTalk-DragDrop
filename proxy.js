Ext.define('LC.dd.CustomProxy', {
    extend : 'Ext.dd.StatusProxy',
    
    msgCount : 0,
    messages : ['Dépose moi ici !', 'Tu te décides ?', 'Bon ça va, lâche moi'],
    nextMessage : function(){
        this.update('<div>' + this.messages[this.msgCount] + '</div>');
        this.msgCount = (this.msgCount + 1) % this.messages.length;
    }
});

Ext.define('LC.plugin.DragDrop2', {
    extend: 'Ext.grid.plugin.DragDrop',
    alias: 'plugin.lcdragdrop2',
    ...
    onViewRender : function(view) {
        ...
        if (me.enableDrag) {
            me.dragZone = new Ext.view.DragZone({
                ...
                proxy : Ext.create('LC.dd.CustomProxy', {
